...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		methods: {
			removeComponentVersion: function removeComponentVersion(component) {
			...
			onAdded: function onAdded(data) {
				var exists = this.components.find(function (c) {
					return c.componentVersionIdData.objectID === data.componentVersionIdData.objectID;
				});
				if (!exists) {
					this.components.push(data);
				}
			},
			onRemoved: function onRemoved(componentVersionId) {
				var component = this.components.find(function (c) {
					return c.componentVersionIdData.objectID === componentVersionId;
				});
				if (component) {
			...
			missing: function missing(props) {
				return props.filter(function (v) {
					return !v.description;
				}).length;
			},
			getComponents: function getComponents(newValue, oldValue) {
				if (oldValue) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(260)('keys', function($keys){
