		...
		methods: {
			onAdded: function onAdded(data) {
				var exists = this.packages.find(function (p) {
					return p.packageVersionIdData.objectID === data.packageVersionIdData.objectID;
				});
				if (!exists) {
					this.packages.push(data);
				}
			},
			onRemoved: function onRemoved(packageVersionId) {
				var pkg = this.packages.find(function (p) {
					return p.packageVersionIdData.objectID === packageVersionId;
				});
				if (pkg) {
